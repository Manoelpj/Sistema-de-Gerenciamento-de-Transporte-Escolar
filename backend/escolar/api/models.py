...
class Aluno(models.Model):
    ...
    responsavel_nome = models.CharField(
        max_length=200, help_text="Nome do responsável pelo aluno"
    )

    endereco = models.TextField(help_text="Endereço residencial do aluno")

    turno = models.CharField(
        max_length=20, choices=TURNO_CHOICES, help_text="Turno em que o aluno estuda"
    )
    ...
    escola = models.CharField(
        max_length=200, help_text="Nome da escola que o aluno frequenta"
    )
    ...
    ativo = models.BooleanField(
        default=True, help_text="Indica se o aluno está ativo no sistema"
    )
